...
<iframe src="files/pages/admin-header.jsp" marginheight="0" hidefocus="true" frameborder="0" scrolling="no" allowtransparency="yes" seamless  tabindex="" style="width: 100%; height:181px;;"></iframe>
	<div class="other">
			...
			<input type="button" value="添加项目" onclick="window.location='createAchievement'">
	...
	<div class="content-wrapper">
	    <div class="news-list">
	    	...
	    	<form id="delMany" action="delManyAchievement" method="post">
	    	<div class="head">
	    		<span class="head-choose">选择</span>
	    		<span class="head-title">所获荣誉</span>
	    		<span class="head-time">获取时间</span>
	    	...
	    	<p class="news-item">
	    		...
	    		<a class="news-title" href="achievementDetail?achievement.id=<s:property value="#ut.id"/>"><s:property value="#ut.name"/></a> 
	    		<span class="operator"><s:a href="editAchievement?achievement.id=%{#ut.id}">编辑</s:a>|<s:a href="delAchievement?achievement.id=%{#ut.id}">删除</s:a></span>
