...
<iframe src="files/pages/admin-header.jsp" marginheight="0" hidefocus="true" frameborder="0" scrolling="no" allowtransparency="yes" seamless  tabindex="" style="width: 100%; height:181px;;"></iframe>
	<div class="other">
			...
			<input type="button" value="添加项目" onclick="window.location='createCompetition'">
	...
	<div class="content-wrapper">
	    <div class="news-list">
	    	...
	    	<form id="delMany" action="delManyCompetition" method="post">
	    	<div class="head">
	    		<span class="head-choose">选择</span>
	    		<span class="head-title">竞赛</span>
	    		<span class="head-time">参赛时间</span>
	    	...
	    	<p class="news-item">
	    		...
	    		<span class="operator"><s:a href="editCompetition?competition.id=%{#ut.id}">编辑</s:a>|<s:a href="delCompetition?competition.id=%{#ut.id}">删除</s:a></span>
