...
<div class="content-wrapper">
	<div class="content clearfix">
		<form class="news" action="updateDownload" method="post">
			<s:hidden value="%{#request.download.id}" name="download.id"/>
			<s:textfield id="newscontent"  value="%{#request.download.path}" />
			<b>文件名</b>
			<br>
			<s:textfield name="download.name" id="title" value="%{#request.download.name}" />
			<br>
			<b>文件分类</b>
			<br>
			<s:select name="download.type" list="#{0:'规章制度',1:'学习资料'}" value="%{#request.download.type}">
			</s:select>
			<br>
			<b>上传</b>
