...
<div class="content-wrapper">
	<div class="content clearfix">
		<div class="mynews">
			<span class="title"><s:property value="%{#request.announcement.title}"/></span>
			<br>
			<div class="news-msg">
				<span class="item">
					<span>作者:</span>
					<s:property value="%{#request.announcement.author}"/>
				</span>
				<span class="item">
					<span>时间:</span>
					<s:date name="%{#request.announcement.time}" format='yyyy-MM-dd'/>
				</span>
			</div>
			<div><s:property value="%{#request.announcement.content}" escape="false"/></div>
		</div>
	</div>
</div>
</body>
