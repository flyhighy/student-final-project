...
<iframe src="files/pages/admin-header.jsp" marginheight="0" hidefocus="true" frameborder="0" scrolling="no" allowtransparency="yes" seamless  tabindex="" style="width: 100%; height:181px;;"></iframe>
	<div class="other">
			...
			<input type="button" value="添加项目" onclick="window.location='addTeam'">
	...
	<div class="content-wrapper">
	    <div class="news-list">
	    	...
	    	<form id="delMany" action="delManyTeam" method="post">
	    	<div class="head">
	    		<span class="head-choose">选择</span>
	    		<span class="head-title">指导团队 </span>
	    		<span class="head-time">成立时间</span>
	    		<span class="head-author">指导老师</span>
	    	...
	    	<p class="news-item">
	    		...
	    		<a class="news-title" href="messageDetail?competition.id=<s:property value="#ut.id"/>"><s:property value="#ut.name"/></a> 
	    		<span class="operator"><s:a href="editTeam?team.id=%{#ut.id}">编辑</s:a>|<s:a href="delTeam?team.id=%{#ut.id}">删除</s:a></span>
	    		<span class="time"><s:date name='%{#ut.time}' format='yyyy-MM-dd'/></span>
	    		<span class="author"><s:property value="#ut.teacher"/></span>
	    	</p>
	    	</s:iterator>
	</form>
	    </div>
