...
<script src="../js/admin-leavemsg.js" charset="utf-8"></script>
</head>
<body>
	...
	<div class="content-wrapper">
		<div class="news-list">
			...
			<form id="delMany" action="delMany" method="post">
				<div class="head">
					<span class="head-choose">选择</span> <span class="head-title">留言人</span>
				<%--  <span class="head-author">学院</span> --%>
					<span class="head-num">留言时间</span> <span class="head-op">操作</span>
				</div>
				<div class="J_apply">
				</div>
			</form>
