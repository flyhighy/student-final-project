...
<script>
	KISSY.use("core",function(S){
		...
		body.delegate("click",".del-many",function(){
			document.getElementById("delManyMsg").submit();
		});
	})
</script>
</head>
...
<iframe src="files/pages/admin-header.jsp" marginheight="0" hidefocus="true" frameborder="0" scrolling="no" allowtransparency="yes" seamless  tabindex="" style="width: 100%; height:181px;;"></iframe>
	...
	<div class="content-wrapper">
	    <div class="news-list">
	    	...
	    	<form id="delManyMsg" action="delManyMsg" method="post">
	    	<div class="head">
	    	...
	    	<p class="news-item">
	    		...
	    		<a class="news-title" href="messageDetail?announcement.id=<s:property value="#ut.id"/>"><s:property value="#ut.title"/></a> 
	    		<span class="operator"><s:a href="editMessage?announcement.id=%{#ut.id}">编辑</s:a>|<s:a href="delMessage?announcement.id=%{#ut.id}">删除</s:a></span>
