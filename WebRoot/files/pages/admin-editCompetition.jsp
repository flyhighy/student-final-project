...
<div class="content-wrapper">
	<div class="content clearfix">
		<form class="news" action="updateCompetition" method="post">
			<s:hidden value="%{#request.competition.id}" name="competition.id"/>
			<b>标题</b>
			<br>
			<s:textfield type="text" name="competition.name" id="title" value="%{#request.competition.name}" />
			<br>
			<b>发布者</b>
			<br>
			<s:textfield type="text" name="competition.author" value="%{#request.competition.author}"/>
			<br>
			<b>参赛时间</b>
			<br>
			<input id="realtime" type="date" name="competition.time"/>
			<br>
			<b>正文</b>
			<s:textfield id="newscontent"  value="%{#request.competition.content}" />
