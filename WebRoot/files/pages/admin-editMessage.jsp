...
<div class="content-wrapper">
	<div class="content clearfix">
		<form class="news" action="updateMessage" method="post">
		<s:hidden value="%{#request.announcement.id}" name="announcement.id"/>
			<b>标题</b>
			<br>
			<s:textfield type="text" name="announcement.title" id="title" value="%{#request.announcement.title}" />
			<br>
			<b>发布者</b>
			<br>
			<s:textfield type="text" name="announcement.author" value="%{#request.announcement.author}"/>
			<br>
			<b>正文</b>
			<s:textfield id="newscontent"  value="%{#request.announcement.content}" />
